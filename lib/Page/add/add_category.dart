  ...
  buttons(){
    if(widget._tb_category.Id_Category==null){
      ...
      return  Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          buttonstyle("حذف",(){},25,100,Colors.white,Colors.blue.shade900,Icons.delete,1),
          buttonstyle("تعديل",(){},25,100,Colors.white,Colors.blue.shade900,Icons.edit,1),
          buttonstyle("الغاء",(){},25,100,Colors.white,Colors.blue.shade900,Icons.cancel,1),
        ],
      );
    }
  }
